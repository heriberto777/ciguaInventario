@echo off
REM Script para configurar la base de datos con los nuevos módulos de inventario
...
call npx prisma migrate dev --name add_inventory_modules
...
echo.
echo 📚 Documentación:
echo   - INVENTORY_FEATURES.md (Descripción completa de módulos)
