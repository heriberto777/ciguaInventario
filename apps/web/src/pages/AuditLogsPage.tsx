    ...
    <div className="space-y-6">
      ...
      {stats && (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-[var(--bg-card)] rounded-lg border border-[var(--border-default)] shadow p-6">
            <p className="text-sm text-[var(--text-secondary)]">Actions</p>
            <p className="text-2xl font-bold text-[var(--text-primary)] mt-2">
          ...
          <div className="bg-[var(--bg-card)] rounded-lg border border-[var(--border-default)] shadow p-6">
            <p className="text-sm text-[var(--text-secondary)]">Top User Activity</p>
            <p className="text-2xl font-bold text-[var(--text-primary)] mt-2">
      ...
      {/* Filters */}
      <div className="bg-[var(--bg-card)] rounded-lg border border-[var(--border-default)] shadow p-4 space-y-3">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2 border border-[var(--border-default)] rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--primary-500)] bg-[var(--bg-input)] text-[var(--text-primary)]"
            >
      ...
      {selectedLog && (
        <div className="fixed inset-0 bg-[var(--overlay-bg)] flex items-center justify-center z-50 p-4">
          <div className="bg-[var(--bg-card)] rounded-lg shadow-lg max-w-2xl w-full max-h-96 overflow-y-auto">
            <div className="p-6">
              <div className="flex justify-between items-start mb-4">
                <h2 className="text-xl font-semibold text-[var(--text-primary)]">Log Details</h2>
                <button
              ...
              <div className="space-y-3">
                ...
                {selectedLog.oldValue && (
                  <div>
                    ...
                    <pre className="bg-[var(--bg-hover)] border border-[var(--border-default)] p-2 rounded text-xs overflow-auto text-[var(--text-primary)]">
